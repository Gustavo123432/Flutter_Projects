...
class _InserirCodePWDState extends State<InserirCodePWD> {
  ...
  Future<void> resendEmail() async {
    ...
    var response = await http.get(Uri.parse(
        'http://appbar.epvc.pt/API//appBarAPI_GET.php?query_param=14&email=$email&tentativa=1'));
 ...
 Future<void> checkCode() async {
  ...
  if (!code.isEmpty && email != null) {
    try {
      var response = await http.get(Uri.parse(
          'http://appbar.epvc.pt/API//appBarAPI_GET.php?query_param=15&code=$code&email=$email'));
