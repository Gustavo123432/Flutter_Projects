...
class CreateProjetoTPage extends StatefulWidget {
  @override
  _CreateProjetoTPageState createState() => _CreateProjetoTPageState();
}

class _CreateProjetoTPageState extends State<CreateProjetoTPage> {
  String _titulo = '';
  String _localizacao = '';
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        Checkbox(
                          // Checkbox para selecionar se inclui ou não IVA
                          value:
                              incluiIVA, // variável que representa se IVA está incluído ou não
                          onChanged: (bool? newValue) {
                            ...
                            setState(() {
                              incluiIVA =
                                  newValue!; // Atualizando o estado do checkbox
                            });
                          },
                        ),
                      ],
