...
class MateriaisT extends StatefulWidget {
  @override
  _MateriaisTState createState() => _MateriaisTState();
}

class _MateriaisTState extends State<MateriaisT> {
                  ...
                  children: [
                    Expanded(
                      child: DataTable(
                        ...
                        columns: [
                          DataColumn(label: Text('Nº Produto')),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
              MaterialPageRoute(builder: (context) => CriaMaterialTPage()));
        },
