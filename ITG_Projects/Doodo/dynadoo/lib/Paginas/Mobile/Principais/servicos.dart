...
import '../../../Paginas/Mobile/Secundárias/criarmaterial.dart';
import '../../../Responsive/responsive_Layout.dart';

class ServicosM extends StatefulWidget {
  @override
  _ServicosMState createState() => _ServicosMState();
}

class _ServicosMState extends State<ServicosM> {
                ...
                Card(
                  ...
                  child: Container(
                    ...
                    padding: EdgeInsets.symmetric(
                        horizontal: 16), // Adiciona um espaçamento horizontal
                    child: Row(
                      children: [
                        Expanded(
                          child: TextField(
                            style: TextStyle(
                                color: Colors
                                    .white), // Estilo do texto da barra de busca
                            decoration: InputDecoration(
                              hintText:
                                  'Pesquisar...', // Texto de dica dentro da barra de busca
                              hintStyle: TextStyle(
                                  color:
                                      Colors.grey), // Estilo do texto de dica
                              border: InputBorder
                                  .none, // Remove a borda da barra de busca
                            ),
                          ),
                        ),
                        IconButton(
                          icon: Icon(Icons.search,
                              color: Colors.white), // Ícone de pesquisa
                          onPressed: () {
