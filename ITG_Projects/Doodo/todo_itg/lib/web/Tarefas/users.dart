...
import 'package:todo_itg/web/Tarefas/createUser.dart';
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          Text(
                         Users[index]['Name'] == null ? "Error 404" : Users[index]['Name'],
                            style: TextStyle(
                              fontSize: 20,
                         ...
                         Users[index]['Type'] == "1" ? "Admin" :   Users[index]['Type'] == "0" ? "User" :"ds" ,
                  ...
                  SizedBox(height: 16),
                  // Contact information
                  buildInfoRow("Email:",       Users[index]['Mail'] == null ? "Error 404"  : Users[index]['Mail']),
                  buildInfoRow("Contacto:",Users[index]['Cont'] == null ? "Error 404" : Users[index]['Cont']),
                  buildInfoRow("Log:", Users[index]['Log'] == null ? "Error 404" : Users[index]['Log']),
                ],
              ),
            ),
          );
